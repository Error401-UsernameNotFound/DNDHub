...
ArtificerLayout = [
    ...
    [sg.Multiline("- Whenever tapped by a creature, the object emits a recorded message that can be heard up to 10 feet away. You utter the message when you bestow this property on the object, and the recording can be no more than 6 seconds long.",s=(80,3),pad=(60,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Multiline("- The object continuously emits your choice of an odor or a nonverbal sound (wind, waves, chirping, or the like). The chosen phenomenon is perceivable up to 10 feet away.",s=(80,3),pad=(60,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Multiline("- A static visual effect appears on one of the object's surfaces. This effect can be a picture, up to 25 words of text, lines and shapes, or a mixture of these elements, as you like.",s=(80,3),pad=(60,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    ...
    [sg.Multiline("You can bestow magic on multiple objects, touching one object each time you use this feature, though a single object can only bear one property at a time. The maximum number of objects you can affect with this feature at one time is equal to your Intelligence modifier (minimum of one object). If you try to exceed your maximum, the oldest property immediately ends, and then the new property applies.",s=(80,5),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Text('Spellcasting',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("You've studied the workings of magic and how to cast spells, channeling the magic through objects. To observers, you don't appear to be casting spells in a conventional way; you appear to produce wonders from mundane items and outlandish inventions.",s=(80,3),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Text('Tools Required',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("You produce your artificer spell effects through your tools. You must have a spellcasting focus - specifically thieves' tools or some kind of artisan's tool - in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See the equipment chapter in the Player's Handbook for descriptions of these tools. After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.",s=(80,7),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 1,
    [sg.Text('Level 2',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Infuse Item',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("At 2nd level, you've gained the ability to imbue mundane items with certain magical infusions, turning those objects into magic items.",s=(80,2),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Text('Infusions Known',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],14))],
    [sg.Multiline("When you gain this feature, pick four artificer infusions to learn. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.\nWhenever you gain a level in this class, you can replace one of the artificer infusions you learned with a new one.",s=(80,5),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Text('Infusing an Item',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],14))],
    [sg.Multiline("Whenever you finish a long rest, you can touch a nonmagical object and imbue it with one of your artificer infusions, turning it into a magic item. An infusion works on only certain kinds of objects, as specified in the infusion's description. If the item requires attunement, you can attune yourself to it the instant you infuse the item. If you decide to attune to the item later, you must do so using the normal process for attunement (see the attunement rules in the Dungeon Master's Guide).\nYour infusion remains in an item indefinitely, but when you die, the infusion vanishes after a number of days equal to your Intelligence modifier (minimum of 1 day). The infusion also vanishes if you replace your knowledge of the infusion.\nYou can infuse more than one nonmagical object at the end of a long rest; the maximum number of objects appears in the Infused Items column of the Artificer table. You must touch each of the objects, and each of your infusions can be in only one object at a time. Moreover, no object can bear more than one of your infusions at a time. If you try to exceed your maximum number of infusions, the oldest infusion ends, and then the new infusion applies.\nIf an infusion ends on an item that contains other things, like a bag of holding, its contents harmlessly appear in and around its space.",s=(80,17),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 2,
    ...
    [sg.Multiline("And its rather lengthy description",s=(80,5),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 5,
    [sg.Text('Level 6',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Tool Expertise',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("At 6th level, your proficiency bonus is now doubled for any ability check you make that uses your proficiency with a tool.",s=(80,2),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 6,
    [sg.Text('Level 7',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Flash of Genius',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("At 7th level, you've gained the ability to come up with solutions under pressure. When you or another creature you can see within 30 feet of you makes an ability check or a saving throw, you can use your reaction to add your Intelligence modifier to the roll.\nYou can use this feature a number of times equal to your Intelligence modifier (minimum of once). You regain all expended uses when you finish a long rest.",s=(80,2),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 7,
    ...
    [sg.Multiline("And its rather lengthy description",s=(80,5),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 9,
    [sg.Text('Level 10',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Magic Item Adept',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("When you reach 10th level, you achieve a profound understanding of how to use and make magic items:",s=(80,2),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    [sg.Text('\t- You can attune to up to four magic items at once.',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    [sg.Multiline("- If you craft a magic item with a rarity of common or uncommon, it takes you a quarter of the normal time, and it costs you half as much of the usual gold.",s=(80,2),pad=(60,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 10,
    [sg.Text('Level 11',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Spell-Storing Item',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("At 11th level, you can now store a spell in an object. Whenever you finish a long rest, you can touch one simple or martial weapon or one item that you can use as a spellcasting focus, and you store a spell in it, choosing a 1st- or 2nd-level spell from the artificer spell list that requires 1 action to cast (you needn't have it prepared).\n\nWhile holding the object, a creature can take an action to produce the spell's effect from it, using your spellcasting ability modifier. If the spell requires concentration, the creature must concentrate. The spell stays in the object until it's been used a number of times equal to twice your Intelligence modifier (minimum of twice) or until you use this feature again to store a spell in an object.",s=(80,10),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 11,
    ...
    [sg.Text('At 14th level, your skill with magic items deepens more:',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    [sg.Text('\t- You can attune to up to five magic items at once.',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    [sg.Text('\t- You ignore all class, race, spell and level requirements on attuning to or using a magic item.',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    #end of level 14,
    [sg.Text('Level 15',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Text('Subclass Feature',s=(45,1),pad=(0,4),font=(sg.DEFAULT_FONT[0],15))],
    [sg.Multiline("And its rather lengthy description",s=(80,5),pad=(0,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
    #end of level 15,
    ...
    [sg.Text('Starting at 18th level, you can attune up to six magic items at once.',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    #end of level 18,
    ...
    [sg.Text('At 20th level, you develop a mystical connection to your magic items, which you can draw on for protection:',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    [sg.Text('\t-You gain a +1 bonus to all saving throws per magic item you are currently attuned to.',pad=(0,0),font=(sg.DEFAULT_FONT[0],10))],
    [sg.Multiline("- If you're reduced to 0 hit points but not killed out-right, you can use your reaction to end one of your artificer infusions, causing you to drop to 1 hit point instead of 0.",s=(80,2),pad=(60,0),font=(sg.DEFAULT_FONT[0],10),disabled=True,background_color='#2c2825',no_scrollbar=True,border_width=0)],
